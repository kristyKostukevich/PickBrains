...
export class AddVacancyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.httpService.getData('http://192.168.43.8:1488/api/meta-data/vacancy-statuses').subscribe(res => {
  ...
  submit() {
    ...
    this.httpService.postData(this.postVacancyInfo, 'http://192.168.43.8:1488/api/vacancies/new')
      .subscribe(() => {
        this.done = true;
      });
  }
