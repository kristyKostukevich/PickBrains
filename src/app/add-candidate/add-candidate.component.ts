...
export class AddCandidateComponent implements OnInit {
  ...
  ngOnInit() {
    this.httpService.getData('http://192.168.43.8:1488/api/meta-data/candidate-statuses').subscribe(res => {
    ...
    this.httpService.getData('http://192.168.43.8:1488/api/meta-data/english-levels').subscribe(res => {
    ...
    this.httpService.getData('http://192.168.43.8:1488/api/meta-data/other-skills').subscribe(res => {
  ...
  submit() {
    ...
    this.httpService.postData(this.postCandidateInfo,'http://192.168.43.8:1488/api/candidates/new')
      .subscribe(() => {
        this.done = true;
      });
  }
